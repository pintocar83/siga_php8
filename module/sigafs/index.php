...
<html>
  <head>
    ...
    <script type="text/javascript" src="library/funciones_generales.js?ver=2.0.1"></script>
    <script type="text/javascript" src="library/sigafs.js?ver=2.0.1"></script>
    <script type='text/javascript' src="<?php print "$file?ver=2.0.2";?>"></script>
  </head>
  <body>
...
<script type="text/javascript" src="library/sigafs_postform.js?ver=2.0.2"></script>