<?php
/**
 *  Definición de las acciones que realiza 'Formulación - Visualizar'.
 *
 *  Define la acciones para cargar la interfaz del módulo 'Formulación - Visualizar'
 *
...
class MODULO{
  public static function onInit(){
    $access=SIGA::access("formulacion");
