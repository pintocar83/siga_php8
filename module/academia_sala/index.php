...
$access=SIGA::access("academia_sala");//null,r,rw,a

switch($action){
  case "onGet":
    header('Content-Type: text/plain; charset=utf-8');
    academia_sala::onGet(SIGA::param("id"));
    break;  
  case "onList":
  case "list":
    header('Content-Type: text/plain; charset=utf-8');
    academia_sala::onList(SIGA::paramUpper("text"),SIGA::param("start"),SIGA::param("limit"),SIGA::param("sort",false));
    break;
  ...
  case "css":
    ...
    academia_sala::onCss($access);
    break;
  case "onJavascript":
  case "js":
  case "javascript":  
    header('Content-Type: text/javascript; charset=utf-8');
    academia_sala::onJavascript($access);
    break;
}
...
class academia_sala{
  ...
  public static function onGet($id){
    ...
    $sql="SELECT * FROM modulo_asl.sala WHERE id='$id'";
  ...
  public static function onList($text,$start,$limit,$sort=''){
    ...
    $sql="SELECT * FROM modulo_asl.sala WHERE UPPER(denominacion) LIKE UPPER('%$text%')";
