...
class MODULO extends usuario{
  public static function onInit(){
    $access=SIGA::access("usuario");//null,r,rw,a    
    switch($_REQUEST["action"]){
      ...
      case "save":
        ...
        print json_encode(self::onSave($access,
                         SIGA::param("id"),
                         SIGA::param("id_persona_responsable"),
                         SIGA::param("usuario"),
                         SIGA::param("clave_type"),
                         SIGA::param("clave_value"),
                         SIGA::param("activo"),
                         SIGA::param("perfil_data",false)));
        break;
      case "onDelete":
      case "delete":
        header('Content-Type: text/plain; charset=utf-8');
