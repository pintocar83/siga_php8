<?php
/**
 *  Definición de las acciones que realiza 'Banco - Reportes'.
 *
 *  Define la acciones para cargar la interfaz del módulo 'Banco - Reportes'
 *
...
class MODULO{
  public static function onInit(){
    $access=SIGA::access("reporte_banco");
