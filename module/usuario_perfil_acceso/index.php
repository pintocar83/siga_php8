...
if(!isset($_REQUEST["action"]))
  exit;
include_once("../../class/usuario_perfil_acceso.class.php");

class MODULO extends usuario_perfil_acceso{
  public static function onInit(){
    $access=SIGA::access("usuario_perfil_acceso");//null,r,rw,a
    switch($_REQUEST["action"]){
      case "onGetSelect":
        header('Content-Type: text/plain; charset=utf-8');
        print json_encode(self::onGetSelect(SIGA::param("perfil")));
        break;
      case "onGet":
        header('Content-Type: text/plain; charset=utf-8');
        print json_encode(self::onGet(SIGA::param("perfil")));
        break;
      case "onListSelect":
        header('Content-Type: text/plain; charset=utf-8');
