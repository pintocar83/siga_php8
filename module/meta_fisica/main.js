siga.define('meta_fisica', {
  extend: 'siga.window',
  title: 'Metas Físicas y Actividades', 
  width: 800,
  height: 640,
  ...
  initComponent: function(){
    ...
    me.items=[
      ...
      },      
      {
          ...
          fieldLabel: 'Acción/Proyecto dentro del Plan Operativo Anual (POA)',
    ...
    me.internal.sort=[{property: 'codigo', direction: 'DESC'},{property: 'accion_codigo', direction: 'DESC'}];
  ...
  onNew: function(){
    ...
    Ext.Ajax.request({
      ...
      success:function(request){
        ...
        me.getCmp("codigo").setValue(result["codigo"]);
  ...
  onGet: function(dataview, record, item, index, e){
    ...
    Ext.Ajax.request({
      ...
      success:function(request){
        ...
        me.getCmp('id_tipo').setValue(result[0]['id_tipo']);
        if(result[0]['id_tipo']=="1" || result[0]['id_tipo']==1) {
  ...
  save: function(){
    var me=this;
    var meta_ene=me.getCmp("meta_ene").getValue()>0?me.getCmp("meta_ene").getValue():0;
    var meta_feb=me.getCmp("meta_feb").getValue()>0?me.getCmp("meta_feb").getValue():0;
    var meta_mar=me.getCmp("meta_mar").getValue()>0?me.getCmp("meta_mar").getValue():0;
    var meta_abr=me.getCmp("meta_abr").getValue()>0?me.getCmp("meta_abr").getValue():0;
    var meta_may=me.getCmp("meta_may").getValue()>0?me.getCmp("meta_may").getValue():0;
    var meta_jun=me.getCmp("meta_jun").getValue()>0?me.getCmp("meta_jun").getValue():0;
    var meta_jul=me.getCmp("meta_jul").getValue()>0?me.getCmp("meta_jul").getValue():0;
    var meta_ago=me.getCmp("meta_ago").getValue()>0?me.getCmp("meta_ago").getValue():0;
    var meta_sep=me.getCmp("meta_sep").getValue()>0?me.getCmp("meta_sep").getValue():0;
    var meta_oct=me.getCmp("meta_oct").getValue()>0?me.getCmp("meta_oct").getValue():0;
    var meta_nov=me.getCmp("meta_nov").getValue()>0?me.getCmp("meta_nov").getValue():0;
    var meta_dic=me.getCmp("meta_dic").getValue()>0?me.getCmp("meta_dic").getValue():0;
