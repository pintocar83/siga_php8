...
if(!isset($_REQUEST["action"]))
    exit;
include("../../class/convertidor.class.php");

class MODULO extends convertidor{
  public static function onInit(){
    $access=SIGA::access("convertidor");    
    switch($_REQUEST["action"]){ 
      ...
      case "save":
        header('Content-Type: text/html; charset=utf-8');
        print json_encode(self::onSave($access, SIGA::param("cuentas",false)));
        break;
      case "onCss":
      case "css":
