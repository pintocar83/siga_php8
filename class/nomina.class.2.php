    ...
    while($sw){
      ...
      foreach($definida as $d => $valor_formula){
        ...
        for($i=0;$i<count($variables_formula);$i++){
          ...
          //$definida[$d]="number_format(".str_replace($variables_formula[$i],"(".trim($definida[$variables_formula[$i]]).")",$definida[$d]).",2,'.','')";        
          $definida[$d]=str_replace($variables_formula[$i],"nf(".trim($definida[$variables_formula[$i]]).")",$definida[$d]);        
          }
        //$definida[$d]="nf(".$definida[$d].",2,'.','')";
        $definida_contar[$d]++;
    ...
    while($sw){
      ...
      foreach($definida as $d => $valor_formula){
        ...
        for($i=0;$i<count($variables_formula);$i++){
          ...
          $definida[$d]=str_replace($variables_formula[$i],"number_format(".trim($definida[$variables_formula[$i]]).",2,'.','')",$definida[$d]);        
          }
