  ...
  <body>
    ...
    <div id="siga-apps">
      ...
      <div id="siga-apps-left" class="left">
        <?php
        for($i=0;$i<count($siga_apps);$i++){
					if(isset($siga_apps[$i]["users"]))
						if(!in_array(SIGA::user(),$siga_apps[$i]["users"]))				
							continue;
...
<script type='text/javascript'>
  ...
  window.onload=function(){
    var version="2.1.61";//para que el navegardor actualice los js y tome los cambios realizados
    siga.boot({
      file:[
        ...
        {url: "library/extjs/6.0.0/theme-gray/theme-gray-all.css", type: 'css', progress: 40, msg: "Hojas de Estilos en Cascada (ExtJS 6)..."},
        {url: "library/jquery/jquery-2.1.4.min.js", type: 'js', progress: 42, msg: "JQuery 2.1.4"},
        {url: "library/extjs/6.0.0/ext-all.js", type: 'js', progress: 45, msg: "ExtJS 6..."},
        {url: "library/extjs/6.0.0/locale-es.js", type: 'js', progress: 70, msg: "ExtJS 6(Lenguaje)..."},
