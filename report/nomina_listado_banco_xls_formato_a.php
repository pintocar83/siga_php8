...
$activeSheet->setCellValueExplicit("A$ln","01750301461000129894",PHPExcel_Cell_DataType::TYPE_STRING);	
$activeSheet->setCellValueExplicit("B$ln",date("Ymd"),PHPExcel_Cell_DataType::TYPE_STRING);	
$activeSheet->setCellValueExplicit("C$ln",str_pad(number_format($total_neto,2,"",""),17,"0",STR_PAD_LEFT),PHPExcel_Cell_DataType::TYPE_STRING);	
$activeSheet->setCellValueExplicit("D$ln",str_pad($c,4,"0",STR_PAD_LEFT),PHPExcel_Cell_DataType::TYPE_STRING);	
$ln++;
...
for($i=0; $i<$c; $i++) { 
	...
	$activeSheet->setCellValueExplicit("G$ln","00",PHPExcel_Cell_DataType::TYPE_STRING);
