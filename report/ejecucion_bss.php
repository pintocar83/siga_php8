...
$comprometido=$db->Execute("SELECT
								...
								SUM(case when C.fecha <= '2018-08-19' then DP.monto/100000 else DP.monto end) AS monto
							FROM
...
$modificado=$db->Execute("SELECT
								DP.id_cuenta_presupuestaria,
								SUM(case when C.fecha <= '2018-08-19' then _if(DP.operacion='DI',-DP.monto,DP.monto)/100000 else _if(DP.operacion='DI',-DP.monto,DP.monto) end) AS monto
							FROM
								modulo_base.detalle_presupuestario AS DP,
								modulo_base.comprobante AS C
							WHERE
